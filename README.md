...
The backend treats the **database as the source of truth**, and frontend state is derived entirely from backend responses and validations.
...
This backend is designed to pair with a separate frontend application where:
...
➡️ Frontend repository URL: https://github.com/Miguel-Venegas/shopnest-frontend
